...
//     const formClose = document.getElementById('formIcon');

//     // form X clicked, close the modal
//     formClose.addEventListener('click', function () {
//         contactLayer.style.display = 'none';
//     })

//     contactForm.addEventListener('clicked', function(){
//         contactLayer.style.display = 'block';
//     })

//     // background clicked, close the modal
//     contactLayer.addEventListener('click', function () {
//         contactLayer.style.display = 'none';
//     })
// }
